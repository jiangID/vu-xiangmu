  ...
  export default {
    ...
    data() {
      return {
        ...
        commentslength: 0,
        newsContent: {},
        userAvatar: "http://jsf5211314.gz01.bdysite.com",
        start: 0,
        end: 10,
        content: '',
        editorOption: {
    ...
    methods: {
      ...
      getChatall(start, end) {
        ...
        this.axios
          .get("http://jsf5211314.gz01.bdysite.com/dist/api/getchatAll.php?chatId=" + this.id)
          .then(res => {
            // reverse
      ...
      chatAddContent() {
        ...
        this.axios.post('http://jsf5211314.gz01.bdysite.com/dist/api/messageAdd.php',ly).then(res=>{
